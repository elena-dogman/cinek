    ...
    <div className='grid grid-cols-1 gap-10 bg-[#1919119] px-10 py-20 md:grid-cols-2 lg:grid-cols-4'>
      ...
      <div>
        ...
        <div className='flex flex-col gap-2 text-sm text-gray-300'>
          <p>
            <Phone className='mr-1 inline-block w-4 text-white' /> <span>+7 (495) 123-4567</span>
          </p>
          <p>
            <Mail className='mr-1 inline-block w-4 text-white' /> <span>dogman.choli@gmail.com</span>
          </p>
        </div>
      </div>
    </div>
