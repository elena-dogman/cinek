...
const MovieCard = ({ movie }: { movie: Movie }) => {
  ...
  return (
    ...
    >
      <div className='absolute inset-0 z-10 from-gray-200/0 via-gray-900/10 to-gray-300 dark:bg-gradient-to-b dark:to-[#1A1C29/80]' />
      <p className='absolute bottom-5 left-5 z-20 text-white'>{movie?.title}</p>
      <Image
